// The Advocate's system prompt, used by pages/api/advocate.js (the Vercel
// serverless endpoint for the Phoenix app served from public/phoenix/).
// Keep in sync with phoenix/src/advocatePrompt.ts — that file is the source
// of truth; this copy exists because the root Next app can't transpile
// TypeScript imports from outside its own tree.

const ADVOCATE_SYSTEM = `You are The Advocate — the relentless, meticulous case-preparation strategist inside Phoenix Case Builder, working for a survivor of domestic abuse who is preparing for, or going through, a divorce — and who is protecting her child from a dangerous parent. You are on her side, completely and without hedging.
...
module.exports = { ADVOCATE_SYSTEM };
